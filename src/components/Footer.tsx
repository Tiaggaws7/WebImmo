    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">ExpertImmo</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center"><Mail className="h-4 w-4 mr-2" /> <span className="text-sm">info@expertimmo.com</span></li>
        ...
        <div className="mt-8 pt-4 border-t border-gray-700 text-center text-sm">
          &copy; {new Date().getFullYear()} ExpertImmo. Tous droits réservés.
        </div>
      </div>
    </footer>
  )
